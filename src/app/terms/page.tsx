...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-20 relative z-10 text-white">
      <h1 className="text-4xl font-extrabold mb-8 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">Terms of Service</h1>
      <div className="glass-panel-heavy p-8 rounded-3xl border border-white/10 prose prose-invert max-w-none space-y-6 text-white/70 text-sm leading-relaxed">
        ...
        <p>By accessing or using the MAGHGO platform ("Service"), you agree to be bound by these Terms of Service. If you do not agree, you may not use the Service.</p>
        ...
        <h2 className="text-xl font-bold text-white">3. Buying & Selling Prompts</h2>
        ...
        <h2 className="text-xl font-bold text-white">4. Payments & Refunds</h2>
        ...
        <h2 className="text-xl font-bold text-white">5. Platform Commission</h2>
        ...
        <p>MAGHGO is provided "as is" without warranties of any kind. We are not liable for any indirect, incidental, or consequential damages arising from the use of the Service.</p>

        <h2 className="text-xl font-bold text-white">9. Contact</h2>
        <p>For questions regarding these terms, please contact <a href="mailto:legal@maghgo.com" className="text-neon-blue hover:underline">legal@maghgo.com</a>.</p>
      </div>
    </div>
  )
}

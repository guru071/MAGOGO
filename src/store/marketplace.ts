...
export interface User { id: string; email: string; name: string; avatar?: string; role: string; isSeller: boolean; bio?: string; totalEarnings: number; currentBalance: number; totalSpent: number; isVerified: boolean; bankName?: string; bankAccount?: string; bankIfsc?: string; upiId?: string; paypalEmail?: string; paymentMethod?: string; createdAt?: string; }

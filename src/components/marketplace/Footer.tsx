        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-white/50">
              ...
              <Link href="/categories" className="hover:text-neon-blue transition-colors">Categories</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-white/50">
              <Link href="/support" className="hover:text-neon-blue transition-colors">Help Center</Link>
          ...
          <div>
            <h4 className="font-semibold text-white mb-3 drop-shadow-[0_0_5px_rgba(255,255,255,0.2)]">Legal</h4>
            <div className="flex flex-col gap-2 text-sm text-white/50">
              <Link href="/terms" className="hover:text-neon-blue transition-colors">Terms of Service</Link>

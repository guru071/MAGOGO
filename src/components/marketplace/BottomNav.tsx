          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {item.badge && (
                  <span className="absolute -top-1 -right-2 bg-neon-pink text-white text-[10px] font-bold h-4 w-4 rounded-full flex items-center justify-center shadow-[0_0_8px_rgba(255,0,128,0.8)] animate-pulse">
                    {item.badge}
                  </span>
                )}
              </div>
              ...
              {isActive && (
                <span className="absolute -bottom-2 h-1 w-1 bg-neon-blue rounded-full shadow-[0_0_5px_rgba(0,210,255,1)] animate-bounce" />
              )}
            </Link>
          )
        })}

    ...
    <Dialog open={showAuthModal} onOpenChange={setShowAuthModal}>
      <DialogContent className="sm:max-w-md glass-panel-heavy border border-white/20 text-white rounded-3xl p-8 shadow-[0_0_50px_rgba(0,0,0,0.8)]">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs"><span className="bg-[#0f172a] px-2 text-white/40">or continue with</span></div>
        </div>
        <button
          onClick={() => useStore.getState().signInWithGoogle()}
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-white/90 text-gray-800 font-medium h-12 rounded-full transition-all"
        >
